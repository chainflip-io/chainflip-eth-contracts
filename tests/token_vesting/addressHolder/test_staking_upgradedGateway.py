...
def test_stake_upgrade_failure(addrs, cf, tokenVestingStaking, scGatewayAddrHolder):
    ...
    tx = tv.fundStateChainAccount(cf.flip, JUNK_HEX, MIN_FUNDING, {"from": addrs.BENEFICIARY})
    ...
    with reverts("Transaction reverted without a reason string"):
        tv.fundStateChainAccount(cf.flip, JUNK_HEX, MIN_FUNDING, {"from": addrs.BENEFICIARY})
