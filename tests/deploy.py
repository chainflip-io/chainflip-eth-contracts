...
def deploy_tokenVestingNoStaking(
    ...
    flip.transfer(tokenVestingNoStaking.address, amount, {"from": deployer, "required_confs": required_confs})
...
def deploy_tokenVestingStaking(
    ...
    flip.transfer(tokenVestingStaking.address, amount, {"from": deployer, "required_confs": required_confs})
