...
INIT_WBTC_SUPPLY = int(20 * 10**6 * 10**8)
INIT_CBBTC_SUPPLY = int(20 * 10**6 * 10**8)
DEFAULT_TOKEN_DECIMALS = 18
WBTC_TOKEN_DECIMALS = 8
CBBTC_TOKEN_DECIMALS = 8
...
REV_MSG_START_AFTER_END = "Vesting: start_ after end_"
REV_MSG_INVALID_CLIFF_TIME = "Vesting: cliff before current time"
REV_MSG_INVALID_START_TIME = "Vesting: start before current time"
REV_MSG_NOT_STARTED = "Vesting: not started"
