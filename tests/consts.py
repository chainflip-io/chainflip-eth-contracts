...
STAKABLE = True
NON_STAKABLE = False
REV_MSG_NO_TOKENS = "TokenVest: no tokens are due"
REV_MSG_NOT_REVOKER = "TokenVest: not the revoker"
REV_MSG_CANNOT_REVOKE = "TokenVest: cannot revoke"
REV_MSG_ALREADY_REVOKED = "TokenVest: token already revoked"
REV_MSG_CANNOT_STAKE = "TokenVest: cannot stake"
REV_MSG_VESTING_EXPIRED = "TokenVest: vesting expired"
REV_MSG_CANNOT_RETRIEVE =  "TokenVest: not retrievable"
REV_MSG_FUNDS_REVOKED =  "TokenVest: staked funds revoked"
REV_MSG_NOT_REVOKED =  "TokenVest: token not revoked"