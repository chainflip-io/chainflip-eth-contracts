...
def test_targetOne_partialInputAmount():
    ...
    # Original value == 39614081257132168796771975168
    assert int(amountIn) == 39614081257132168796771975168
    # Original value == 39614120871253040049813
    assert int(feeAmount) == 39614120871253036236800
    assert int(amountIn) + int(feeAmount) <= 3915081100057732413702495386755767
    # Original value: 0 => we have removed the rounding because we dont care about it
    assert int(amountOut) == 1
    assert int(sqrtQ) == 1
