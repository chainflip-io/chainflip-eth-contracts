...
contract Vault is IVault, AggKeyNonceConsumer, GovernanceCommunityGuarded {
    ...
    // Hardcoded Deposit.sol bytecode to prevent different bytecodes generated by different setups
    bytes public constant DEPOSIT_BYTECODE_PRECOMPILED =
        hex"";
    ...
    function _deployAndFetchBatch(DeployFetchParams[] calldata deployFetchParamsArray) private {
        ...
        for (uint256 i = 0; i < length; ) {
            _deployDepositViaCreate2(uint256(deployFetchParamsArray[i].swapID), deployFetchParamsArray[i].token);
            unchecked {
                ++i;
            }
        }
    ...
    function _deployDepositViaCreate2(uint256 salt, address token) private {
        address addr;
        bytes memory bytecodeToDeploy = abi.encodePacked(DEPOSIT_BYTECODE_PRECOMPILED, abi.encode(token));
        // solhint-disable-next-line no-inline-assembly
        assembly {
            addr := create2(
                0,
                add(bytecodeToDeploy, 0x20), // Actual code starts after skipping the first 32 bytes
                mload(bytecodeToDeploy), // Load the size of code contained in the first 32 bytes
                salt
            )
