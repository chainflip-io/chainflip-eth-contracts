...
// INSTRUCTIONS
//
// This command deploys the localnet BSC Chainlink mock price feeds if they are missing.
// It expects the BSC localnet image to already contain the core Chainflip contracts.
// Set BSC_INIT_BUILD_ONLY=true to only verify that the mock feed bytecode can be built.
