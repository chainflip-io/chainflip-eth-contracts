...
#         print("perc", perc)
#         print("diff", pool.ticksLimitTokens1[0].oneMinusPercSwap - percSwappedPrev)
...
#             toUint256(
#                 pool.ticksLimitTokens1[0].oneMinusPercSwap - percSwappedPrev
#             ),
#             FixedPoint128_Q128,
...
#         percSwappedPrev = pool.ticksLimitTokens1[0].oneMinusPercSwap
#         counter += 1
